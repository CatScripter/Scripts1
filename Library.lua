...
if game:GetService("CoreGui"):FindFirstChild("CatHub") then
    tempPos = game:GetService("CoreGui").CatHub.Frame.Position + UDim2.new(0,0,2,0)
    game.TweenService:Create(game:GetService("CoreGui").CatHub.Frame, TweenInfo.new(2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),{
    	Position = tempPos
    }):Play()
    wait(2)
    game:GetService("CoreGui").CatHub:Destroy()
end
if cathub_connect then
    for i,v in pairs(cathub_connect) do
        v:Disconnect()
    end
end
NotifCount = 0
...
function lib.Notification(Name,DelayNotif,ColorZ)
    ...
    Notif.Name = "Notif"
    Notif.Parent = game:GetService("CoreGui").CatHub
...
function lib.Window(Name, Des, Image, DefBind)
	...
	game.TweenService:Create(game:GetService("CoreGui").CatHub.Frame, TweenInfo.new(.8, Enum.EasingStyle.Quart, Enum.EasingDirection.Out),{
    ...
    cathub_connect[#cathub_connect+1] = Frame.InputChanged:Connect(function(a)
        if a.UserInputType == Enum.UserInputType.MouseMovement or a.UserInputType == Enum.UserInputType.Touch then
            dragInput = a
        end
    end)
	cathub_connect[#cathub_connect+1] = Frame.InputBegan:Connect(function(a)
        if a.UserInputType == Enum.UserInputType.MouseButton1 or a.UserInputType == Enum.UserInputType.Touch then
            dragging = true
            dragStart = a.Position
		    startPos = Frame.Position
		    
		    cathub_connect[#cathub_connect+1] = a.Changed:Connect(function()
    ...
    cathub_connect[#cathub_connect+1] = UserInputService.InputChanged:Connect(function(a)
	...
	local por = true
	cathub_connect[#cathub_connect+1] = Bind.MouseButton1Click:Connect(function() 
		local zdd
		por = false
		Bind.Text = "..."
	...
	cathub_connect[#cathub_connect+1] = game.UserInputService.InputBegan:Connect(function(b)
	...
	function Tabs:Tab(Name,Image)
    	...
    	cathub_connect[#cathub_connect+1] = Tab.MouseButton1Down:Connect(function()
    		if not d then
    			d = true
        ...
        function SubSections:SubSection(Name)
            ...
            function Item:Button(Name,Callback)
                ...
                cathub_connect[#cathub_connect+1] = Button.MouseButton1Click:Connect(function()
                    ButtonFun:Click()
                end)
            	cathub_connect[#cathub_connect+1] = Button.MouseEnter:Connect(function()
            	...
            	cathub_connect[#cathub_connect+1] = Button.MouseLeave:Connect(function()
            		game.TweenService:Create(Frame_3, TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),{
            ...
            function Item:Toggle(Name,Def,Callback)
            	...
            	cathub_connect[#cathub_connect+1] = Toggle.MouseButton1Click:Connect(function() 
            		toggle = not toggle
            ...
            function Item:DropDown(Name,ListAll,Callback)
                ...
                function DropDownFunc:Update(ListDrop)
                    ...
                    for i,v in pairs(ListScroll:GetChildren()) do
                        if v:IsA("Frame") then
                    		...
                    		cathub_connect[#cathub_connect+1] = v.TextButton.MouseButton1Click:Connect(function()
            	...
            	cathub_connect[#cathub_connect+1] = TextButton.MouseButton1Click:Connect(function()
            	    OrC()
            	end)
            	...
            	cathub_connect[#cathub_connect+1] = TextBox.Focused:connect(function()
            	    if not ListScroll.Visible then
            	        OrC()
            	    end
            	end)
            	cathub_connect[#cathub_connect+1] = TextBox.FocusLost:connect(function()
            	...
            	cathub_connect[#cathub_connect+1] = TextBox.Changed:Connect(function(z)
            	    if z == "Text" then
            	        for i,v in pairs(ListScroll:GetChildren()) do
            	            if v:IsA("Frame") then
            ...
            function Item:TextBox(Name,Def,Callback)
                ...
                cathub_connect[#cathub_connect+1] = TextBox_2.FocusLost:Connect(function()
            ...
            function Item:KeyBind(Name,Def,Callback,List)
            	...
            	cathub_connect[#cathub_connect+1] = TextButton_3.MouseButton1Click:Connect(function() 
            		local piska
            		TextButton_3.Text = "..."
            ...
            function Item:Slider(Name,min,max,current,spam,Callback)
            	...
            	cathub_connect[#cathub_connect+1] = Bar.MouseButton1Down:Connect(function()
            		isDown = true
            	...
            	cathub_connect[#cathub_connect+1] = UserInputService.InputEnded:Connect(function(input, gp)
            	...
            	cathub_connect[#cathub_connect+1] = PlayerMouse.Move:Connect(function()
            		if isDown == true then
            			local tween;
